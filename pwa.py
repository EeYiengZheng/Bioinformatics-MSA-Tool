...
class PWA(object):
    ...
    def print_aligned_seq(self):
        if self.aligned_sequences:
            print(self.aligned_sequences[0], " ", self.get_fasta_comment(self.fasta_list[0]))
            print(self.aligned_sequences[1], " ", self.get_fasta_comment(self.fasta_list[1]))
    ...
    def __align(self, match, mismatch, gap, sub_matrix):
        seq1 = self.strip_fasta_comment(self.fasta_list[0])
        seq2 = [list(c) for c in list(self.strip_fasta_comment(self.fasta_list[1]))]
    ...
    def __insert_indel(self):
        ...
        """
        seq1 = self.strip_fasta_comment(self.fasta_list[0])
        seq2 = self.strip_fasta_comment(self.fasta_list[1])
        new_seq1 = ""
        new_seq2 = ""
        ...
        local = False
        if self.alignment_method.name == AlignmentMethod.LOCAL.name:
            local = True
    ...
    def get_fasta_comment(self, seq: str):
        """
